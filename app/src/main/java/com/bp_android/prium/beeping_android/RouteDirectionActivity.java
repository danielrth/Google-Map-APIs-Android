...
public class RouteDirectionActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public class PositionsTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public boolean getPositions() {
            ...
            String requestURL = serverUrl + "devices/" + device.getId() + "?access_token="
                    + PrefManager.getInstance(RouteDirectionActivity.this).getToken();
