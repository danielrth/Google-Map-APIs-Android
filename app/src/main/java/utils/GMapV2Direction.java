...
public class GMapV2Direction {
    ...
    public final static String MODE_FLIGHT = "flights";
    ...
    public Document getDocument(LatLng start, LatLng end, String mode) {
        ...
        //String url = "http://maps.googleapis.com/maps/api/directions/xml?origin=39.899,116.43&destination=22.3786,113.975&sensor=false&units=metric&mode=flight";
        String response = HttpUtils.HttpGetWithEntity(url);
        Log.d("url", url);
